...
public class Exercises1 extends AppCompatActivity {
    ...
    private static final String TAG = "lxz";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mLifecycleDisplay.setText(app.getValue());
    ...
    protected void onDestroy() {
        ...
        app.setValue(mLifecycleDisplay.getText().toString());
    }
//    @Override
...
//        if (outState != null){
//            String store =  mLifecycleDisplay.getText().toString();
//            outState.putString("TEST", store);
//        }
//
//    }
//
...
//            mLifecycleDisplay.setText(test);
//
//        }
//    }
